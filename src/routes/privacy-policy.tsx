...
const TITLE = "Privacy Policy — SELEN";
const DESCRIPTION =
  "How SELEN, operated by Bharat Gold Ornaments Private Limited, collects, uses, and discloses your personal information when you visit or shop on selen.in.";
...
function PrivacyPolicy() {
  return (
    <LegalLayout title="Privacy Policy" lastUpdated="16 July 2026">
      <p>
        SELEN operates this store and website, including all related information, content,
        features, tools, products and services, in order to provide you, the customer, with a
        curated shopping experience (the &ldquo;Services&rdquo;). SELEN is powered by Shopify,
      ...
      <p>
        SELEN is owned and operated by Bharat Gold Ornaments Private Limited (&ldquo;SELEN&rdquo;,
        &ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;).
      </p>

      <p>
        Please read this Privacy Policy carefully. By using and accessing any of the Services, you
        acknowledge that you have read this Privacy Policy and understand the collection, use,
        and disclosure of your information as described in this Privacy Policy.
      </p>

      <LegalSection heading="Personal Information We Collect or Process">
        <p>
          When we use the term &ldquo;personal information,&rdquo; we are referring to information
          that identifies or can reasonably be linked to you or another person. Personal
          information does not include information that is collected anonymously or that has been
          de-identified, so that it cannot identify or be reasonably linked to you. We may collect
          or process the following categories of personal information, including inferences drawn
      ...
      <LegalSection heading="Personal Information Sources">
      ...
      <LegalSection heading="How We Use Your Personal Information">
        <p>
      ...
      <LegalSection heading="How We Disclose Personal Information">
        <p>
          In certain circumstances, we may disclose your personal information to third parties
          for legitimate purposes subject to this Privacy Policy. Such circumstances may include:
        </p>
        <LegalList
          items={[
      ...
      <LegalSection heading="Relationship with Shopify">
        <p>
          ...
          shared with Shopify as well as third parties that may be located in countries other than
          where you reside, in order to provide and improve the Services for you. In addition, to
          help protect, grow, and improve our business, we use certain Shopify enhanced features
          that incorporate data and information obtained from your interactions with our Store,
          along with other merchants and with Shopify. To provide these enhanced features, Shopify
          may make use of personal information collected about your interactions with our store,
          along with other merchants, and with Shopify. In these circumstances, Shopify is
          responsible for the processing of your personal information, including for responding to
          your requests to exercise your rights over use of your personal information for these
          purposes. To learn more about how Shopify uses your personal information and any rights
          you may have, you can visit the Shopify Consumer Privacy Policy. Depending on where you
          live, you may exercise certain rights with respect to your personal information via the
          Shopify Privacy Portal.
        </p>
      </LegalSection>

      <LegalSection heading="Third Party Websites and Links">
        <p>
          ...
          us or by a third party. Our inclusion of such links does not, by itself, imply any
      ...
      <LegalSection heading="Children's Data">
        <p>
          ...
          information, you may contact us using the contact details set out below to request that
          it be deleted. As of the Effective Date of this Privacy Policy, we do not have actual
          knowledge that we &ldquo;share&rdquo; or &ldquo;sell&rdquo; (as those terms are defined in
          applicable law) personal information of individuals under 16 years of age.
        </p>
      </LegalSection>

      <LegalSection heading="Security and Retention of Your Information">
        <p>
          Please be aware that no security measures are perfect or impenetrable, and we cannot
          guarantee &ldquo;perfect security.&rdquo; In addition, any information you send to us
          may not be secure while in transit. We recommend that you do not use unsecure channels to
      ...
      <LegalSection heading="Your Rights and Choices">
        ...
        />
        <p>
          You may exercise any of these rights where indicated on the Services or by contacting us
          using the contact details provided below. To learn more about how Shopify uses your
          personal information and any rights you may have, including rights related to data
          processed by Shopify, you can visit the{" "}
          <a
        ...
        <p>
          ...
          them to act on your behalf, and we may need you to verify your identity directly with
          us. We will respond to your request in a timely manner as required under applicable law.
        </p>
      </LegalSection>
      ...
      <LegalSection heading="Complaints">
        <p>
          ...
          using the contact details provided below. Depending on where you live, you may have the
          right to appeal our decision by contacting us using the contact details set out below, or
      ...
      <LegalSection heading="International Transfers">
        ...
        <p>
          ...
          Commission&rsquo;s Standard Contractual Clauses, or any equivalent contracts issued by
          the relevant competent authority of the UK, as relevant, unless the data transfer is to a
      ...
      <LegalSection heading="Changes to This Privacy Policy">
        <p>
          ...
          revised Privacy Policy on this website, update the &ldquo;Last updated&rdquo; date and
      ...
      <LegalSection heading="Contact">
        <p>
          ...
          you would like to exercise any of the rights available to you, please contact us at:
        </p>
        <LegalContact
          lines={[
